...
SECRET_KEY=your_secret_key DEBUG=True DATABASE_URL=mongodb://localhost:27017/your_db_name JWT_SECRET=your_jwt_secret RAZORPAY_KEY=your_razorpay_key REDIS_URL=redis://localhost:6379/0

Deployment

Deploy on AWS, DigitalOcean, or Heroku.

Use Gunicorn & Nginx for production setup.
